...
typedef enum { NO_SAVE_SLOT = 0xFF } ManiaSaveSlots;
#endif //! GAME_IS_MANIA
...
typedef enum { NO_SAVE_SLOT = 0xFF } S3SaveSlots;
#endif //! GAME_IS_S3
#endif //! GAME_NO_VARIABLES
...
#define SetGameFinished() RSDK.SetGameFinished();
#else
